...
{
    public partial class ucInventory_PurchaseOrder_CartItem : UserControl
    {
        ...
        public ucInventory_PurchaseOrder_CartItem()
        {
            InitializeComponent();
        }
        ...
        {
            deleteMe = true;
            var targetForm = Application.OpenForms.OfType<frmInventory_PurchaseOrder_AddNewTransaction>().Single();
