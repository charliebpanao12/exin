...
{
    public partial class ucInventory_InventoryIn_CartItem : UserControl
    {
        ...
        public ucInventory_InventoryIn_CartItem()
        {
            InitializeComponent();
        }
        ...
        {
            deleteMe = true;
            var targetForm = Application.OpenForms.OfType<frmInventory_InventoryIn_AddNewTransaction>().Single();
