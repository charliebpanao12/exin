...
namespace EXIN
{
    public partial class UCSOA : UserControl
    {
        ...
        public UCSOA()
        {
            ...
            frmController.Instance.PnlTitle.Controls["lblPageTitle"].Text = "Statement of Accounts";
        }
        ...
        public void readSOAData()
        {
            ...
            this.Invoke((MethodInvoker)delegate
            {
                ...
                dgvSOA.Columns[0].Width = 120;
                dgvSOA.Columns[1].Width = 100;
                dgvSOA.Columns[2].Width = 100;
                dgvSOA.Columns[3].Width = 100;
                dgvSOA.Columns[4].Width = 100;
                dgvSOA.Columns[5].Width = 250;
        ...
        private void dgvSOA_MouseHover(object sender, EventArgs e)
        {
            dgvSOA.ScrollBars = ScrollBars.Both;
        }

        private void dgvSOA_MouseLeave(object sender, EventArgs e)
        {
            dgvSOA.ScrollBars = ScrollBars.None;
        }
    }
}
